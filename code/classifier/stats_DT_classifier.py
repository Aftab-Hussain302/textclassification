...
if __name__ == '__main__':
    ...
    for flaw_index in range(6):
        ...
        min_samples_split = target_param[1]
        min_samples_leaf = target_param[2]
        max_features = target_param[3]
        ...
        for train, test in kfold.split(X_train_stats, y_train):
            ...
            ### Decision Tree ###
            clf = tree.DecisionTreeClassifier(max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf, max_features=max_features)
